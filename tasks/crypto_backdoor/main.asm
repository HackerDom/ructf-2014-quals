...
_TEXT SEGMENT
text_text DB "all about crypto", 0 ; test phrase to encrypt/decrypt in standalone version
s_box DD 030fb40d4H
	DD	09fa0ff0bH
	DD	06beccd2fH
	DD	03f258c7aH
...
main	PROC
	...
	push	32
	push	eax
	mov	DWORD PTR _key$[ebp], 1768779620 ; hardcoded key for testin purposes
	call	set_key
